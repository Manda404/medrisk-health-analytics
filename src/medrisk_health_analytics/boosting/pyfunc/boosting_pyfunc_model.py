        ...
        if ext == ".json":
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install medrisk-health-analytics[xgboost]"
                ) from exc
            ...
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install medrisk-health-analytics[catboost]"
                ) from exc
            ...
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install medrisk-health-analytics[lightgbm]"
                ) from exc
