"""
Clinical constants used across the medrisk-health-analytics package.
...
BMI_NORMAL_MAX: float = 25.0  # 18.5–24.99 → Normal  (cut at 25.0, right=False)
BMI_OVERWEIGHT_MAX: float = 30.0  # 25.0–29.99 → Overweight; ≥ 30 → Obese
